...
<div id="header" class='header-landing-page header-homepage'>
  ...
  <div class='login-form'>
    <form action="/user_sessions" class="new_user_session" id="login" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="pbxcQHzEqTh1j0ka1qRAdPiV7q0s1vcy9L6C3L4vq/k=" /></div>
  ...
  <div class="intro">
    ...
    <div id='right_image'>
     ...
     <div id="middle">
       <form action="/users" class="column-right" id="new_user" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="pbxcQHzEqTh1j0ka1qRAdPiV7q0s1vcy9L6C3L4vq/k=" /></div>
